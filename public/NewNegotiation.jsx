...
function NewNegotiation({ formStatus, setFormStatus, activeAccount, setActiveAccount }) {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('gmail', 'maritech', e.target, 'user_ERKzPIkK5byCFbAKgFKlO')
            .then((result) => {
    ...
    return (
        <div className='main-content-container px-4 container-fluid'>
            ...
            <span> {/* Reset local storage button */}
                <a href="/maritech/" onClick={() => resetLocalStorage()} style={{ color: 'silver', float: "right" }}>
                    {svgRefreshPage}
                </a>
            </span>
                ...
                activeAccount === 'Bob' && formStatus === null
                    ...
                    : <div className="formContainer">
                        ...
                        <nav className="d-flex formNav">
                            <button href="#" className='nav-link active'>Americano</button>
                            <button href="#" className='nav-link'>Flat White</button>
                            <button href="#" className='nav-link'>Black Coffee</button>
                        </nav>
                        ...
                        <div className="preForm d-flex">
                            ...
                            <div className="participants d-inline-flex">
                                <button className="participantsMembers" type="button">Alice B. {svgXcircle}</button>
                                <button className="participantsMembers" type="button">Bob A. {svgXcircle}</button>
                        ...
                        >
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(vesselName)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {vesselName[vesselName.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(account)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {account[account.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(loadRange)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {loadRange[loadRange.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(dischargeRange)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {dischargeRange[dischargeRange.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(laycan)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {laycan[laycan.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(quantity)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {quantity[quantity.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                {activeAccount === 'Bob'
                                    ...
                                    /> :
                                    null}
                                <p className={paragraphChangingVisible(grade)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {grade[grade.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(freight)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {freight[freight.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(overage)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {overage[overage.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(demurrage)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {demurrage[demurrage.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(laytime)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {laytime[laytime.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(addCom)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {addCom[addCom.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(thirteenthCheckbox)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {thirteenthCheckbox[thirteenthCheckbox.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(ammLastDone)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {ammLastDone[ammLastDone.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(subsDue)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {subsDue[subsDue.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(l3c)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {l3c[l3c.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(iternary)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {iternary[iternary.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(subsDue2)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {subsDue2[subsDue2.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(tbokApproved)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {tbokApproved[tbokApproved.length - 2]}</p>
                            </div>
                            ...
                            <div className="formItem">
                                ...
                                <p className={paragraphChangingVisible(firmFor)}>This item was changed by the client This clause has been changed by the client, your previous proposal: {firmFor[firmFor.length - 2]}</p>
                            </div>
                            ...
                            {activeAccount === 'Alice' && formStatus === null
                                ...
                                : <div>
                                    {(formStatus === 'Proposed' && activeAccount === 'Bob') || (formStatus === 'counteroffer' && activeAccount === 'Alice')
                                        ? <div className='response'>
                                            <button
                                                type="button"
                                                className="accept"
                                                onClick={checkAllCheckboxStatus() ? () => setFormStatus('ACCEPTED') : () => handleSubmit()}
                                            >
