...
function NewNegotiation({ formStatus, setFormStatus, activeAccount, setActiveAccount }) {
    ...
    const handleSubmit = () => {
        ...
        if (
            !OfferType.disabled &&
            localState.offerType[localState.offerType.length - 1] !== OfferType.value
        ) {
            localState.setOfferType([...localState.offerType, OfferType.value]);
        }

        if (
            !NegotiationTitle.disabled &&
            localState.negotiationTitle[localState.negotiationTitle.length - 1] !== NegotiationTitle.value
        ) {
        ...
        if (
            !VesselName.disabled &&
            localState.vesselName[localState.vesselName.length - 1] !== VesselName.value
        ) {
        ...
        if (
            !LoadRange.disabled &&
            localState.loadRange[localState.loadRange.length - 1] !== LoadRange.value
        ) {
            localState.setLoadRange([...localState.loadRange, LoadRange.value]);
            localState.setLoadRangeHistory([
                ...localState.loadRangeHistory,
                `${localState.loadRange.length + 1}. At ${nowTime} by ${activeAccount}: ${LoadRange.value}`,
            ]);
        }

        if (
            !DischargeRange.disabled &&
            localState.dischargeRange[localState.dischargeRange.length - 1] !== DischargeRange.value
        ) {
            localState.setDischargeRange([...localState.dischargeRange, DischargeRange.value]);
            localState.setDischargeRangeHistory([
                ...localState.dischargeRangeHistory,
                `${localState.dischargeRange.length + 1}. At ${nowTime} by ${activeAccount}: ${
                    DischargeRange.value
                }`,
            ]);
        }
        ...
        if (!Laycan.disabled && localState.laycan[localState.laycan.length - 1] !== Laycan.value) {
            ...
            localState.setLaycanHistory([
                ...localState.laycanHistory,
                `${localState.laycan.length + 1}. At ${nowTime} by ${activeAccount}: From ${
                    Laycan.value
                } to ${LaycanEnd.value}`,
            ]);
        }
        ...
        if (
            !LaycanEnd.disabled &&
            localState.laycanEnd[localState.laycanEnd.length - 1] !== LaycanEnd.value
        ) {
            localState.setLaycanEnd([...localState.laycanEnd, LaycanEnd.value]);
            localState.setLaycanEndHistory([
                ...localState.laycanEndHistory,
                `${localState.laycanEnd.length + 1}. At ${nowTime} by ${activeAccount}: From ${
                    Laycan.value
                } to ${LaycanEnd.value}`,
            ]);
        }
        ...
        if (!Quantity.disabled && localState.quantity[localState.quantity.length - 1] !== +Quantity.value) {
            ...
            localState.setQuantityHistory([
                ...localState.quantityHistory,
                `${localState.quantity.length + 1}. At ${nowTime} by ${activeAccount}: ${Quantity.value}`,
            ]);
        }

        if (
            !QuantitytUnits.disabled &&
            localState.quantityUnits[localState.quantityUnits.length - 1] !== QuantitytUnits.value
        ) {
        ...
        if (!Grade.disabled && localState.grade[localState.grade.length - 1] !== Grade.value) {
            ...
            localState.setGradeHistory([
                ...localState.gradeHistory,
                `${localState.grade.length + 1}. At ${nowTime} by ${activeAccount}: ${Grade.value}`,
            ]);
        }
        ...
        if (!Freight.disabled && localState.freight[localState.freight.length - 1] !== Freight.value) {
            ...
            localState.setFreightHistory([
                ...localState.freightHistory,
                `${localState.freight.length + 1}. At ${nowTime} by ${activeAccount}: ${Freight.value}`,
            ]);
        }

        if (
            !FreightUnits.disabled &&
            localState.freightUnits[localState.freightUnits.length - 1] !== FreightUnits.value
        ) {
        ...
        if (!Overage.disabled && localState.overage[localState.overage.length - 1] !== +Overage.value) {
            ...
            localState.setOverageHistory([
                ...localState.overageHistory,
                `${localState.overage.length + 1}. At ${nowTime} by ${activeAccount}: ${Overage.value}`,
            ]);
        }

        if (
            !OverageUnits.disabled &&
            localState.overageUnits[localState.overageUnits.length - 1] !== OverageUnits.value
        ) {
        ...
        if (
            !Demurrage.disabled &&
            localState.demurrage[localState.demurrage.length - 1] !== +Demurrage.value
        ) {
            localState.setDemurrage([...localState.demurrage, +Demurrage.value]);
            localState.setDemurrageHistory([
                ...localState.demurrageHistory,
                `${localState.demurrage.length + 1}. At ${nowTime} by ${activeAccount}: ${Demurrage.value}`,
            ]);
        }

        if (
            !DemurrageUnits.disabled &&
            localState.demurrageUnits[localState.demurrageUnits.length - 1] !== DemurrageUnits.value
        ) {
        ...
        if (!Laytime.disabled && localState.laytime[localState.laytime.length - 1] !== +Laytime.value) {
            ...
            localState.setLaytimeHistory([
                ...localState.laytimeHistory,
                `${localState.laytime.length + 1}. At ${nowTime} by ${activeAccount}: ${Laytime.value}`,
            ]);
        }

        if (
            !LaytimeUnits.disabled &&
            localState.laytimeUnits[localState.laytimeUnits.length - 1] !== LaytimeUnits.value
        ) {
        ...
        if (!AddCom.disabled && localState.addCom[localState.addCom.length - 1] !== +AddCom.value) {
            ...
            localState.setAddComHistory([
                ...localState.addComHistory,
                `${localState.addCom.length + 1}. At ${nowTime} by ${activeAccount}: ${AddCom.value}`,
            ]);
        }

        if (
            !BrokerCom.disabled &&
            localState.brokerCom[localState.brokerCom.length - 1] !== +BrokerCom.value
        ) {
            localState.setBrokerCom([...localState.brokerCom, +BrokerCom.value]);
            localState.setBrokerComHistory([
                ...localState.brokerComHistory,
                `${localState.brokerCom.length + 1}. At ${nowTime} by ${activeAccount}: ${BrokerCom.value}`,
            ]);
        }

        if (
            !AmmLastDone.disabled &&
            localState.ammLastDone[localState.ammLastDone.length - 1] !== AmmLastDone.value
        ) {
            localState.setAmmLastDone([...localState.ammLastDone, AmmLastDone.value]);
            localState.setAmmLastDoneHistory([
                ...localState.ammLastDoneHistory,
                `${localState.ammLastDone.length + 1}. At ${nowTime} by ${activeAccount}: ${
                    AmmLastDone.value
                }`,
            ]);
        }
        ...
        if (!SubsDue.disabled && localState.subsDue[localState.subsDue.length - 1] !== SubsDue.value) {
            ...
            localState.setSubsDueHistory([
                ...localState.subsDueHistory,
                `${localState.subsDue.length + 1}. At ${nowTime} by ${activeAccount}: ${SubsDue.value}`,
            ]);
        }

        if (!L3C.disabled && localState.l3c[localState.l3c.length - 1] !== L3C.value) {
            localState.setl3c([...localState.l3c, L3C.value]);
            localState.setl3cHistory([
                ...localState.l3cHistory,
                `${localState.l3c.length + 1}. At ${nowTime} by ${activeAccount}: ${L3C.value}`,
            ]);
        }

        if (
            !Itinerary.disabled &&
            localState.itinerary[localState.itinerary.length - 1] !== Itinerary.value
        ) {
            localState.setItinerary([...localState.itinerary, Itinerary.value]);
            localState.setItineraryHistory([
                ...localState.itineraryHistory,
                `${localState.itinerary.length + 1}. At ${nowTime} by ${activeAccount}: ${Itinerary.value}`,
            ]);
        }
        ...
        if (
            !TbokApproved.disabled &&
            localState.tbokApproved[localState.tbokApproved.length - 1] !== TbokApproved.value
        ) {
            localState.setTbokApproved([...localState.tbokApproved, TbokApproved.value]);
            localState.setTbokApprovedHistory([
                ...localState.tbokApprovedHistory,
                `${localState.tbokApproved.length + 1}. At ${nowTime} by ${activeAccount}: ${
                    TbokApproved.value
                }`,
            ]);
        }
        ...
        if (
            !OtherTextArea.disabled &&
            localState.otherTextArea[localState.otherTextArea.length - 1] !== OtherTextArea.value
        ) {
            localState.setOtherTextArea([...localState.otherTextArea, OtherTextArea.value]);
            localState.setOtherTextAreaHistory([
                ...localState.otherTextAreaHistory,
                `${localState.otherTextArea.length + 1}. At ${nowTime} by ${activeAccount}: ${
                    OtherTextArea.value
                }`,
            ]);
        }
        ...
        if (!FirmFor.disabled && localState.firmFor[localState.firmFor.length - 1] !== +FirmFor.value) {
            ...
            localState.setFirmForHistory([
                ...localState.firmForHistory,
                `${localState.firmFor.length + 1}. At ${nowTime} by ${activeAccount}: ${FirmFor.value}`,
            ]);
        }

        if (
            !FirmForUnits.disabled &&
            localState.firmForUnits[localState.firmForUnits.length - 1] !== FirmForUnits.value
        ) {
    ...
    const offerStatus = (formStatus, activeAccount) => {
        if (
            (formStatus === 'Proposed' || formStatus === 'counteroffer by Alice') &&
            activeAccount === 'Alice'
        ) {
        ...
        if (
            (activeAccount === 'Alice' &&
                (formStatus === 'ACCEPTED' || formStatus === `ACCEPTED with Alice's updates`)) ||
        ...
        if (
            (formStatus === 'counteroffer' || formStatus === 'counteroffer by Bob') &&
            activeAccount === 'Alice'
        ) {
    ...
    const orderDecision = () => {
        ...
        if (
            formStatus === 'counteroffer' ||
            formStatus === 'counteroffer by Bob' ||
            formStatus === 'counteroffer by Alice'
        ) {
            return 'counteroffer';
        }
    };
    ...
    const checkInputStatus = (numCheckbox) => {
        if (
            activeAccount === 'Alice' &&
            (formStatus === 'counteroffer by Alice' || formStatus === 'Proposed')
        ) {
            return true;
        }
    ...
    const timerClass = () => {
        if (
            formStatus === 'ACCEPTED' ||
            formStatus === `ACCEPTED with Alice's updates` ||
            formStatus === `ACCEPTED with Bob's updates` ||
            formStatus === 'DECLINED' ||
            formStatus === null
        ) {
            return 'non-visible';
    ...
    const declineHandler = () => {
        let confirmDecline = window.confirm(
            'Are you sure you would like to end this negotiation? This action cannot be undone.',
        );
    ...
    return (
        <div className="main-content-container px-4 container-fluid">
            ...
            {activeAccount === 'Bob' && formStatus === null ? (
                <div>
                    <h3>No new offers</h3>
                    <h4 id="timer" className={timerClass()}>
                        {' '}
                    </h4>
                </div>
            ) : (
                <div className="formContainer">
                    ...
                    {activeAccount === 'Alice' ? (
                        <nav className="d-flex formNav">
                            ...
                            <button href="#" className="nav-link">
                                Flat White<div className="newUpdates"></div>
                            </button>
                            <button href="#" className="nav-link">
                                Black Coffee (BP)
                            </button>
                            <button href="#" className="nav-link">
                                Black Coffee (Shell)<div className="newUpdates"></div>
                            </button>
                        </nav>
                    ) : (
                        <nav className="d-flex formNav">
                            ...
                            <div className="preForm d-flex">
                                ...
                                <div className="participants">
                                    <button className="participantsMembers" type="button">
                                        Alice B. <br />
                                        (Morning Cup Shipping) {svgXcircle}
                                    </button>

                                    {localState.participants.map((el, index) => (
                                        <button className="participantsMembers" type="button" key={index}>
                                            {el[0]} <br /> {el[1]} {svgXcircle}
                                        </button>
                                    ))}

                                    <SimpleModal
                                        participants={localState.participants}
                                        setParticipants={localState.setParticipants}
                                    />
                                </div>
                            </div>
                                    ...
                                    <div className="fullForm">
                                        ...
                                        <div className="formItem">
                                            ...
                                            <select
                                                id="VesselName"
                                                defaultValue={
                                                    localState.vesselName[localState.vesselName.length - 1]
                                                }
                                        ...
                                        <div className="formItem">
                                            ...
                                            <select
                                                id="Account"
                                                defaultValue={
                                                    localState.account[localState.account.length - 1]
                                                }
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                defaultValue={
                                                    localState.loadRange[localState.loadRange.length - 1]
                                                }
                                                className={inputClassName(
                                                    localState.thirdCheckbox,
                                                    localState.loadRange,
                                                )}
                                            ...
                                            <p className={paragraphChangingVisible(localState.loadRange)}>
                                                {localState.loadRangeHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                defaultValue={
                                                    localState.dischargeRange[
                                                        localState.dischargeRange.length - 1
                                                    ]
                                                }
                                                disabled={checkInputStatus(localState.fourthCheckbox)}
                                                className={inputClassName(
                                                    localState.fourthCheckbox,
                                                    localState.dischargeRange,
                                                )}
                                            />
                                            <button type="button">{svgAddField}</button>
                                            ...
                                            <p
                                                className={paragraphChangingVisible(
                                                    localState.dischargeRange,
                                                )}
                                            >
                                                {localState.dischargeRangeHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                            ...
                                            {checkboxVisible() ? (
                                                <div className="d-inline">
                                                    <input
                                                        ...
                                                        display="none"
                                                        defaultChecked={
                                                            localState.fifthCheckbox ? true : false
                                                        }
                                                    />
                                                    {/* <input
                                            onChange={() => handleCheckBox()}
                                        ...
                                        /> */}
                                            ...
                                            <input
                                                ...
                                                defaultValue={
                                                    localState.laycanEnd[localState.laycanEnd.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.fifthCheckbox)}
                                                className={inputClassName(
                                                    localState.fifthCheckbox,
                                                    localState.laycanEnd,
                                                )}
                                            />

                                            <p className={paragraphChangingVisible(localState.laycan)}>
                                                {localState.laycanHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                            ...
                                            <p className={paragraphChangingVisible(localState.laycanEnd)}>
                                                {localState.laycanEndHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                min={0}
                                                defaultValue={
                                                    localState.quantity[localState.quantity.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.sixthCheckbox)}
                                                className={inputClassName(
                                                    localState.sixthCheckbox,
                                                    localState.quantity,
                                                )}
                                            />
                                            <select
                                                id="QuantitytUnits"
                                                defaultValue={
                                                    localState.quantityUnits[
                                                        localState.quantityUnits.length - 1
                                                    ]
                                                }
                                                disabled={checkInputStatus(localState.sixthCheckbox)}
                                                className={inputClassName(
                                            ...
                                            <p className={paragraphChangingVisible(localState.quantity)}>
                                                {localState.quantityHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                className={inputClassName(
                                                    localState.seventhCheckbox,
                                                    localState.grade,
                                                )}
                                            />

                                            <p className={paragraphChangingVisible(localState.grade)}>
                                                {localState.gradeHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                placeholder="140"
                                                defaultValue={
                                                    localState.freight[localState.freight.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.eighthCheckbox)}
                                                className={inputClassName(
                                                    localState.eighthCheckbox,
                                                    localState.freight,
                                                )}
                                            />
                                            <select
                                                id="FreightUnits"
                                                defaultValue={
                                                    localState.freightUnits[
                                                        localState.freightUnits.length - 1
                                                    ]
                                                }
                                                disabled={checkInputStatus(localState.eighthCheckbox)}
                                                className={inputClassName(
                                            ...
                                            <p className={paragraphChangingVisible(localState.freight)}>
                                                {localState.freightHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                placeholder="140"
                                                defaultValue={
                                                    localState.overage[localState.overage.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.ninethCheckbox)}
                                                className={inputClassName(
                                                    localState.ninethCheckbox,
                                                    localState.overage,
                                                )}
                                            />
                                            <select
                                                id="OverageUnits"
                                                defaultValue={
                                                    localState.overageUnits[
                                                        localState.overageUnits.length - 1
                                                    ]
                                                }
                                                disabled={checkInputStatus(localState.ninethCheckbox)}
                                                className={inputClassName(
                                            ...
                                            <p className={paragraphChangingVisible(localState.overage)}>
                                                {localState.overageHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                placeholder="25000"
                                                defaultValue={
                                                    localState.demurrage[localState.demurrage.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.tenthCheckbox)}
                                                className={inputClassName(
                                                    localState.tenthCheckbox,
                                                    localState.demurrage,
                                                )}
                                            />
                                            <select
                                                id="DemurrageUnits"
                                                defaultValue={
                                                    localState.demurrageUnits[
                                                        localState.demurrageUnits.length - 1
                                                    ]
                                                }
                                                disabled={checkInputStatus(localState.tenthCheckbox)}
                                                className={inputClassName(
                                            ...
                                            <p className={paragraphChangingVisible(localState.demurrage)}>
                                                {localState.demurrageHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            {checkboxVisible() ? (
                                                <input
                                                    ...
                                                    display="none"
                                                    defaultChecked={
                                                        localState.eleventhCheckbox ? true : false
                                                    }
                                                />
                                            ) : null}
                                            <label>Laytime</label>
                                            <input
                                                ...
                                                placeholder="24"
                                                defaultValue={
                                                    localState.laytime[localState.laytime.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.eleventhCheckbox)}
                                                className={inputClassName(
                                                    localState.eleventhCheckbox,
                                                    localState.laytime,
                                                )}
                                            />
                                            <select
                                                id="LaytimeUnits"
                                                defaultValue={
                                                    localState.laytimeUnits[
                                                        localState.laytimeUnits.length - 1
                                                    ]
                                                }
                                                disabled={checkInputStatus(localState.eleventhCheckbox)}
                                                className={inputClassName(
                                            ...
                                            <p className={paragraphChangingVisible(localState.laytime)}>
                                                {localState.laytimeHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <p className={paragraphChangingVisible(localState.addCom)}>
                                                {localState.addComHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            {checkboxVisible() ? (
                                                <input
                                                    ...
                                                    display="none"
                                                    defaultChecked={
                                                        localState.thirteenthCheckbox ? true : false
                                                    }
                                                />
                                            ) : null}
                                            ...
                                            <input
                                                ...
                                                placeholder="25"
                                                defaultValue={
                                                    localState.brokerCom[localState.brokerCom.length - 1]
                                                }
                                                disabled={checkInputStatus(localState.thirteenthCheckbox)}
                                                className={inputClassName(
                                                    localState.thirteenthCheckbox,
                                                    localState.brokerCom,
                                                )}
                                            />
                                            <select
                                                id="BrokerComUnits"
                                            ...
                                            <p className={paragraphChangingVisible(localState.brokerCom)}>
                                                {localState.brokerComHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            {checkboxVisible() ? (
                                                <input
                                                    ...
                                                    display="none"
                                                    defaultChecked={
                                                        localState.fourteenthCheckbox ? true : false
                                                    }
                                                />
                                            ) : null}
                                            <label>
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                defaultValue={
                                                    localState.ammLastDone[localState.ammLastDone.length - 1]
                                                }
                                                className={inputClassName(
                                                    localState.fourteenthCheckbox,
                                                    localState.ammLastDone,
                                                )}
                                            ...
                                            <p className={paragraphChangingVisible(localState.ammLastDone)}>
                                                {localState.ammLastDoneHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            {checkboxVisible() ? (
                                                <input
                                                    ...
                                                    display="none"
                                                    defaultChecked={
                                                        localState.fifteenthCheckbox ? true : false
                                                    }
                                                />
                                            ) : null}
                                            ...
                                            <input
                                                ...
                                                id="SubsDue"
                                                defaultValue={
                                                    localState.subsDue[localState.subsDue.length - 1]
                                                }
                                                className={inputClassName(
                                                    localState.fifteenthCheckbox,
                                                    localState.subsDue,
                                                )}
                                            ...
                                            <p className={paragraphChangingVisible(localState.subsDue)}>
                                                {localState.subsDueHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <p className={paragraphChangingVisible(localState.l3c)}>
                                                {localState.l3cHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                defaultValue={
                                                    localState.itinerary[localState.itinerary.length - 1]
                                                }
                                            ...
                                            <p className={paragraphChangingVisible(localState.itinerary)}>
                                                {localState.itineraryHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                defaultValue={
                                                    localState.tbokApproved[
                                                        localState.tbokApproved.length - 1
                                                    ]
                                                }
                                            ...
                                            <p className={paragraphChangingVisible(localState.tbokApproved)}>
                                                {localState.tbokApprovedHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem">
                                            {checkboxVisible() ? (
                                                <input
                                                    ...
                                                    id="21thCheckBox"
                                                    defaultChecked={
                                                        localState.twentyoneCheckbox ? true : false
                                                    }
                                                />
                                            ) : null}
                                            <label>Other</label>
                                            <textarea
                                                ...
                                                type="text"
                                                defaultValue={
                                                    localState.otherTextArea[
                                                        localState.otherTextArea.length - 1
                                                    ]
                                                }
                                                className={inputClassName(
                                                    localState.twentyoneCheckbox,
                                                    localState.otherTextArea,
                                                )}
                                        ...
                                        <div className="formItem">
                                            ...
                                            <p
                                                className={
                                                    paragraphChangingVisible(localState.otherTextArea) +
                                                    ' text-left'
                                                }
                                            >
                                                {localState.otherTextAreaHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        <div className="formItem firmFor">
                                            ...
                                            <input
                                                ...
                                                // placeholder="30"
                                                defaultValue={
                                                    localState.firmFor[localState.firmFor.length - 1]
                                                }
                                            ...
                                            <select
                                                id="FirmForUnits"
                                                defaultValue={
                                                    localState.firmForUnits[
                                                        localState.firmForUnits.length - 1
                                                    ]
                                                }
                                                //disabled={checkInputStatus(localState.twentiethCheckbox)}
                                            ...
                                            <p className={paragraphChangingVisible(localState.firmFor)}>
                                                {localState.firmForHistory.map((el, index) => (
                                                    <span key={index}>
                                                        {' '}
                                                        {el} <br />{' '}
                                                    </span>
                                        ...
                                        {(activeAccount === 'Alice' &&
                                            (formStatus === 'Proposed' ||
                                                formStatus === 'counteroffer by Alice')) ||
                                        (activeAccount === 'Bob' &&
                                            formStatus === 'counteroffer by Bob') ? null : activeAccount ===
                                              'Alice' && formStatus === null ? (
                                            ...
                                            <div>
                                                <div className="response">
                                                    <button
                                                        ...
                                                        className="accept"
                                                        onClick={
                                                            localState.checkAllCheckboxStatus()
                                                                ? () => counteroffersCheck()
                                                                : () => handleSubmit()
                                                        }
                                                    >
